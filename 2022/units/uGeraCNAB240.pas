...
uses
  ...
  procedure GeraCNAB240SegmentoR(var F: TextFile; iReg : integer; sComandoMovimento : string);
        ...
        begin
          ...
          try
            ...
            try
              ...
              begin
                iReg := iReg + 1;
                GeraCNAB240SegmentoR(F,iReg,sComandoMovimento);
              end;
...
begin
  ...
  WriteLn(F,
                ...
                Copy(Replicate(' ',1),1,1)                                                                  // 233 a 240 (009) Uso Exclusivo FEBRABAN / CNAB
                );
