...
uses
  ...
  Datasnap.DBClient, IBX.IBDatabase, uConectaBancoSmall;
...
begin
  ...
  qryEmitente := CriaIBQuery(FoTransaction);
  try
    qryEmitente.Close;
    qryEmitente.SQL.Clear;
    qryEmitente.SQL.Add('SELECT FIRST 1 CRT FROM EMITENTE');
    qryEmitente.Open;
