...
type
  TFEmissorNFSe = class(TForm)
    ...
    {DECLARAÃ‡Ã•ES COMUNS PARA AMBOS OS MÃ‰TODOS}
    {CriaÃ§Ã£o do Form}
...
{IMPLEMENTAÃ‡ÃƒO UTILIZANDO COMPONENTE NFSeV2}

function RetornaValorDaTagNoCampo(sTag: String; sObs: String): String;
// Extrai o valor do parâmetro configurado
// Parâmetros:
// sTag: Nome da tag parâmetro
// sObs: Texto onde está a tag com a configuração
...
begin
  ...
  '.Número RPS  : '+edtNumeroRPS.Text    +chr(10)+
  '.Série RPS   : '+edtSerieRPS.Text     +chr(10)+
...
begin
  ...
  begin
    ...
    mmTipado.Lines.Add('NÃºmero do RPS: ' + NFSe.RetornoWSNotasTomadas.Items[i].NumeroRps);
    mmTipado.Lines.Add('NÃºmero da NFS-e: ' + NFSe.RetornoWSNotasTomadas.Items[i].NumeroNFSe);
    mmTipado.Lines.Add('Data de EmissÃ£o: ' + NFSe.RetornoWSNotasTomadas.Items[i].DataEmissaoNFSe);
    mmTipado.Lines.Add('CÃ³digo de VerificaÃ§Ã£o: ' + NFSe.RetornoWSNotasTomadas.Items[i].CodVerificacao);
    mmTipado.Lines.Add('SituaÃ§Ã£o: ' + NFSe.RetornoWSNotasTomadas.Items[i].Situacao);
    ...
    mmTipado.Lines.Add('Data de AutorizaÃ§Ã£o: ' + NFSe.RetornoWSNotasTomadas.Items[i].DataAutorizacao);
