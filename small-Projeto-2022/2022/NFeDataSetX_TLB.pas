...
// PASTLWTR : 1.2
// File generated on 19/07/2020 14:28:32 from Type Library described below.
...
// *********************************************************************//
  IspdXmlDataSetXDisp = dispinterface
    ...
    procedure Edit; dispid 205;
    procedure Post; dispid 206;
  end;
...
begin
  DefaultInterface.Set_ValidaRegrasNegocio(Value);
end;
...
begin
  DefaultInterface.Set_ValidaRegrasNegocioTecno(Value);
end;
...
procedure TspdXmlDataSetX.Edit;
begin
  DefaultInterface.Edit;
end;

procedure TspdXmlDataSetX.Post;
begin
