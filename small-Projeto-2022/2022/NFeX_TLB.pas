...
// PASTLWTR : 1.2
// File generated on 14/03/2022 14:00:55 from Type Library described below.
...
{$IF CompilerVersion >= 23}
  Winapi.Windows, Winapi.ActiveX, System.Classes, Vcl.Graphics, Vcl.OleServer, System.Win.StdVCL, System.Variants;
{$ELSE}
...
// Constants for enum TipoAtorInteressado
type
  TipoAtorInteressado = TOleEnum;
const
  tEAtorInterEmitente = $00000001;
  tEAtorInterDestinatario = $00000002;
  tEAtorInterTransportadora = $00000003;

// Constants for enum TipoAutorizacaoAtorInteressado
type
  TipoAutorizacaoAtorInteressado = TOleEnum;
const
  tEAINaoPermite = $00000000;
  tEAIPermite = $00000001;

// Constants for enum TipoAtorComprovanteEntrega
type
  TipoAtorComprovanteEntrega = TOleEnum;
const
  tEACompEntregaEmitente = $00000001;
  tEACompEntregaDestinatario = $00000002;
  tEACompEntregaEmpresa = $00000003;
  tEACompEntregaFisco = $00000005;
  tEACompEntregaRFB = $00000006;
  tEACompEntregaOutros = $00000009;

// Constants for enum UseTLS
type
  UseTLS = TOleEnum;
const
  utNoTLSSupport = $00000000;
  utUseImplicitTLS = $00000001;
  utUseRequireTLS = $00000002;
  utUseExplicitTLS = $00000003;
...
// *********************************************************************//
  IspdCustomNFe = interface(IDispatch)
    ...
    procedure Set_ImprimirLocalRetiradaEntrega(Value: WordBool); safecall;
    function GetVencimentoCertificadoDataHora: WideString; safecall;
    function Get_InfCplQuebrarLinhaAut: WordBool; safecall;
    procedure Set_InfCplQuebrarLinhaAut(Value: WordBool); safecall;
    function Get_ConfigTextoRodapeEsq: WideString; safecall;
    procedure Set_ConfigTextoRodapeEsq(const Value: WideString); safecall;
    function Get_ConfigTextoRodapeDir: WideString; safecall;
    procedure Set_ConfigTextoRodapeDir(const Value: WideString); safecall;
    function Get_MensagemIcmsDesonerado: WordBool; safecall;
    procedure Set_MensagemIcmsDesonerado(Value: WordBool); safecall;
    function Get_EmailEmitente: WideString; safecall;
    procedure Set_EmailEmitente(const Value: WideString); safecall;
    function Get_CnpjSoftwareHouse: WideString; safecall;
    procedure Set_CnpjSoftwareHouse(const Value: WideString); safecall;
    function Get_TokenSoftwareHouse: WideString; safecall;
    procedure Set_TokenSoftwareHouse(const Value: WideString); safecall;
    function Get_EmailUseSecureBlackBox: WordBool; safecall;
    procedure Set_EmailUseSecureBlackBox(Value: WordBool); safecall;
    function Get_EmailQtdeTentativas: Integer; safecall;
    procedure Set_EmailQtdeTentativas(Value: Integer); safecall;
    function Get_EmailUseTLS: UseTLS; safecall;
    procedure Set_EmailUseTLS(Value: UseTLS); safecall;
    ...
    property InfCplQuebrarLinhaAut: WordBool read Get_InfCplQuebrarLinhaAut write Set_InfCplQuebrarLinhaAut;
    property ConfigTextoRodapeEsq: WideString read Get_ConfigTextoRodapeEsq write Set_ConfigTextoRodapeEsq;
    property ConfigTextoRodapeDir: WideString read Get_ConfigTextoRodapeDir write Set_ConfigTextoRodapeDir;
    property MensagemIcmsDesonerado: WordBool read Get_MensagemIcmsDesonerado write Set_MensagemIcmsDesonerado;
    property EmailEmitente: WideString read Get_EmailEmitente write Set_EmailEmitente;
    property CnpjSoftwareHouse: WideString read Get_CnpjSoftwareHouse write Set_CnpjSoftwareHouse;
    property TokenSoftwareHouse: WideString read Get_TokenSoftwareHouse write Set_TokenSoftwareHouse;
    property EmailUseSecureBlackBox: WordBool read Get_EmailUseSecureBlackBox write Set_EmailUseSecureBlackBox;
    property EmailQtdeTentativas: Integer read Get_EmailQtdeTentativas write Set_EmailQtdeTentativas;
    property EmailUseTLS: UseTLS read Get_EmailUseTLS write Set_EmailUseTLS;
  end;
...
// *********************************************************************//
  IspdCustomNFeDisp = dispinterface
    ...
    property InfCplQuebrarLinhaAut: WordBool dispid 939;
    property ConfigTextoRodapeEsq: WideString dispid 940;
    property ConfigTextoRodapeDir: WideString dispid 941;
    property MensagemIcmsDesonerado: WordBool dispid 942;
    property EmailEmitente: WideString dispid 944;
    property CnpjSoftwareHouse: WideString dispid 945;
    property TokenSoftwareHouse: WideString dispid 946;
    property EmailUseSecureBlackBox: WordBool dispid 947;
    property EmailQtdeTentativas: Integer dispid 948;
    property EmailUseTLS: UseTLS dispid 949;
  end;
...
// *********************************************************************//
  IspdNFeX = interface(IspdCustomNFe)
    ...
    function CalculaChaveInutilizacao(const aAno: WideString; const aCNPJCPF: WideString; 
                                      const aModelo: WideString; const aSerie: WideString; 
                                      const aNFIni: WideString; const aNFFin: WideString): WideString; safecall;
    ...
    procedure Set_DiagnosticMode(Value: WordBool); safecall;
    function ObterCodigoUF(const aUF: WideString): Integer; safecall;
    function Get_HttpLibs: WideString; safecall;
    procedure Set_HttpLibs(const Value: WideString); safecall;
    function TratarXMLRetornoDFe(const aXML: WideString; const aDiretorio: WideString): WideString; safecall;
    function EnviarAtorInteressado(const aChaveNFe: WideString; const aOrgao: WideString; 
                                   const aDataHoraEvento: WideString; const aIdLote: WideString; 
                                   const aOrgaoAutor: WideString; 
                                   const aCnpjCpfAutorizado: WideString; 
                                   const aVersaoAplicativo: WideString; aSequenciaEvento: SYSINT; 
                                   aTpAutor: TipoAtorInteressado; 
                                   aTpAutorizacao: TipoAutorizacaoAtorInteressado; 
                                   const aFusoHorario: WideString): WideString; safecall;
    function EnviarComprovanteEntrega(const aChaveNFe: WideString; const aOrgao: WideString; 
                                      const aDataHoraEvento: WideString; const aIdLote: WideString; 
                                      const aOrgaoAutor: WideString; 
                                      const aDataHoraEntrega: WideString; 
                                      const aVersaoAplicativo: WideString; 
                                      const aFusoHorario: WideString; 
                                      const aNumDocIdent: WideString; 
                                      const aNomeAssinanteComp: WideString; 
                                      const aLatitude: WideString; const aLongitude: WideString; 
                                      const aPathImagemEntrega: WideString; 
                                      aSequenciaEvento: SYSINT; aTpAutor: TipoAtorComprovanteEntrega): WideString; safecall;
    function CancelarComprovanteEntrega(const aIdLote: WideString; const aChaveNFe: WideString; 
                                        const aNumProtocoloEvento: WideString; 
                                        const aOrgao: WideString; const aOrgaoAutor: WideString; 
                                        const aVersaoAplicativo: WideString; 
                                        const aDataHoraEvento: WideString; 
                                        const aFusoHorario: WideString; aSequenciaEvento: SYSINT; 
                                        aTpAutor: TipoAtorComprovanteEntrega): WideString; safecall;
    function Get_ModeloDanfeXmlResumo: WideString; safecall;
    procedure Set_ModeloDanfeXmlResumo(const Value: WideString); safecall;
    function CalcularCodigoBarrasNFeOffline(const aXmlEnvio: WideString): WideString; safecall;
    ...
    property ModeloDanfeXmlResumo: WideString read Get_ModeloDanfeXmlResumo write Set_ModeloDanfeXmlResumo;
  end;
...
// *********************************************************************//
  IspdNFeXDisp = dispinterface
    ...
    function CalculaChaveInutilizacao(const aAno: WideString; const aCNPJCPF: WideString; 
                                      const aModelo: WideString; const aSerie: WideString; 
                                      const aNFIni: WideString; const aNFFin: WideString): WideString; dispid 372;
    ...
    function ObterCodigoUF(const aUF: WideString): Integer; dispid 377;
    property HttpLibs: WideString dispid 378;
    function TratarXMLRetornoDFe(const aXML: WideString; const aDiretorio: WideString): WideString; dispid 379;
    function EnviarAtorInteressado(const aChaveNFe: WideString; const aOrgao: WideString; 
                                   const aDataHoraEvento: WideString; const aIdLote: WideString; 
                                   const aOrgaoAutor: WideString; 
                                   const aCnpjCpfAutorizado: WideString; 
                                   ...
                                   aTpAutor: TipoAtorInteressado; 
                                   aTpAutorizacao: TipoAutorizacaoAtorInteressado; 
                                   const aFusoHorario: WideString): WideString; dispid 308;
    function EnviarComprovanteEntrega(const aChaveNFe: WideString; const aOrgao: WideString; 
                                      const aDataHoraEvento: WideString; const aIdLote: WideString; 
                                      const aOrgaoAutor: WideString; 
                                      const aDataHoraEntrega: WideString; 
                                      ...
                                      const aLatitude: WideString; const aLongitude: WideString; 
                                      const aPathImagemEntrega: WideString; 
                                      aSequenciaEvento: SYSINT; aTpAutor: TipoAtorComprovanteEntrega): WideString; dispid 309;
    function CancelarComprovanteEntrega(const aIdLote: WideString; const aChaveNFe: WideString; 
                                        const aNumProtocoloEvento: WideString; 
                                        const aOrgao: WideString; const aOrgaoAutor: WideString; 
                                        const aVersaoAplicativo: WideString; 
                                        const aDataHoraEvento: WideString; 
                                        const aFusoHorario: WideString; aSequenciaEvento: SYSINT; 
                                        aTpAutor: TipoAtorComprovanteEntrega): WideString; dispid 312;
    property ModeloDanfeXmlResumo: WideString dispid 313;
    function CalcularCodigoBarrasNFeOffline(const aXmlEnvio: WideString): WideString; dispid 344;
    property DiretorioTemplates: WideString dispid 101;
    property NomeCertificado: WideString dispid 102;
    property TipoCertificado: TipoCertificado dispid 103;
    property Proxy: WideString dispid 104;
...
{$ENDIF}
  ...
  protected
    ...
    procedure Set_IdCSRT(const Value: WideString);
    function Get_CSRT: WideString;
    procedure Set_CSRT(const Value: WideString);
    function Get_ImprimirLocalRetiradaEntrega: WordBool;
    procedure Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
    function Get_InfCplQuebrarLinhaAut: WordBool;
    procedure Set_InfCplQuebrarLinhaAut(Value: WordBool);
    function Get_ConfigTextoRodapeEsq: WideString;
    procedure Set_ConfigTextoRodapeEsq(const Value: WideString);
    function Get_ConfigTextoRodapeDir: WideString;
    procedure Set_ConfigTextoRodapeDir(const Value: WideString);
    function Get_MensagemIcmsDesonerado: WordBool;
    procedure Set_MensagemIcmsDesonerado(Value: WordBool);
    function Get_EmailEmitente: WideString;
    procedure Set_EmailEmitente(const Value: WideString);
    function Get_CnpjSoftwareHouse: WideString;
    procedure Set_CnpjSoftwareHouse(const Value: WideString);
    function Get_TokenSoftwareHouse: WideString;
    procedure Set_TokenSoftwareHouse(const Value: WideString);
    function Get_EmailUseSecureBlackBox: WordBool;
    procedure Set_EmailUseSecureBlackBox(Value: WordBool);
    function Get_EmailQtdeTentativas: Integer;
    procedure Set_EmailQtdeTentativas(Value: Integer);
    function Get_EmailUseTLS: UseTLS;
    procedure Set_EmailUseTLS(Value: UseTLS);
  public
    ...
    function GetVencimentoCertificadoDataHora: WideString;
...
{$ENDIF}
  ...
  protected
    ...
    function Get_UltimoLogEnvioMde: WideString;
    procedure Set_UltimoLogEnvioMde(const Value: WideString);
    function Get_UltimoLogRetornoMde: WideString;
    procedure Set_UltimoLogRetornoMde(const Value: WideString);
    function Get_DiagnosticMode: WordBool;
    procedure Set_DiagnosticMode(Value: WordBool);
    function Get_HttpLibs: WideString;
    procedure Set_HttpLibs(const Value: WideString);
    function Get_ModeloDanfeXmlResumo: WideString;
    procedure Set_ModeloDanfeXmlResumo(const Value: WideString);
  ...
  public
    ...
    function CalculaChaveInutilizacao(const aAno: WideString; const aCNPJCPF: WideString; 
                                      const aModelo: WideString; const aSerie: WideString; 
                                      const aNFIni: WideString; const aNFFin: WideString): WideString;
    function ObterCodigoUF(const aUF: WideString): Integer;
    function TratarXMLRetornoDFe(const aXML: WideString; const aDiretorio: WideString): WideString;
    function EnviarAtorInteressado(const aChaveNFe: WideString; const aOrgao: WideString; 
                                   const aDataHoraEvento: WideString; const aIdLote: WideString; 
                                   const aOrgaoAutor: WideString; 
                                   const aCnpjCpfAutorizado: WideString; 
    ...
    function EnviarComprovanteEntrega(const aChaveNFe: WideString; const aOrgao: WideString; 
                                      ...
                                      const aLatitude: WideString; const aLongitude: WideString; 
                                      const aPathImagemEntrega: WideString; 
                                      aSequenciaEvento: SYSINT; aTpAutor: TipoAtorComprovanteEntrega): WideString;
    function CancelarComprovanteEntrega(const aIdLote: WideString; const aChaveNFe: WideString; 
                                        const aNumProtocoloEvento: WideString; 
                                        const aOrgao: WideString; const aOrgaoAutor: WideString; 
                                        const aVersaoAplicativo: WideString; 
                                        const aDataHoraEvento: WideString; 
                                        const aFusoHorario: WideString; aSequenciaEvento: SYSINT; 
                                        aTpAutor: TipoAtorComprovanteEntrega): WideString;
    function CalcularCodigoBarrasNFeOffline(const aXmlEnvio: WideString): WideString;
...
function TspdCustomNFe.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdCustomNFe.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.IdCSRT := Value;
end;

function TspdCustomNFe.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdCustomNFe.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.CSRT := Value;
end;

function TspdCustomNFe.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdCustomNFe.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdCustomNFe.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdCustomNFe.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdCustomNFe.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdCustomNFe.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.ConfigTextoRodapeEsq := Value;
end;

function TspdCustomNFe.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdCustomNFe.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.ConfigTextoRodapeDir := Value;
end;

function TspdCustomNFe.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdCustomNFe.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdCustomNFe.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdCustomNFe.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.EmailEmitente := Value;
end;

function TspdCustomNFe.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdCustomNFe.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.CnpjSoftwareHouse := Value;
end;

function TspdCustomNFe.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdCustomNFe.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.TokenSoftwareHouse := Value;
end;

function TspdCustomNFe.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdCustomNFe.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdCustomNFe.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdCustomNFe.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdCustomNFe.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdCustomNFe.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdCustomNFe.GetVencimentoCertificadoDataHora: WideString;
begin
  Result := DefaultInterface.GetVencimentoCertificadoDataHora;
end;
...
function TspdCustomNFeProperties.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdCustomNFeProperties.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdCustomNFeProperties.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdCustomNFeProperties.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdCustomNFeProperties.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdCustomNFeProperties.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdCustomNFeProperties.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdCustomNFeProperties.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdCustomNFeProperties.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdCustomNFeProperties.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdCustomNFeProperties.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdCustomNFeProperties.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdCustomNFeProperties.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdCustomNFeProperties.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdCustomNFeProperties.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdCustomNFeProperties.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdCustomNFeProperties.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdCustomNFeProperties.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdCustomNFeProperties.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdCustomNFeProperties.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeSCAN.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdNFeSCAN.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdNFeSCAN.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdNFeSCAN.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdNFeSCAN.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdNFeSCAN.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdNFeSCAN.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdNFeSCAN.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdNFeSCAN.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdNFeSCAN.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdNFeSCAN.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdNFeSCAN.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdNFeSCAN.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdNFeSCAN.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCAN.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdNFeSCAN.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdNFeSCAN.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdNFeSCAN.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdNFeSCAN.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdNFeSCAN.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeSCAN.Get_UltimoLogEnvioMde: WideString;
begin
    Result := DefaultInterface.UltimoLogEnvioMde;
end;

procedure TspdNFeSCAN.Set_UltimoLogEnvioMde(const Value: WideString);
  { Warning: The property UltimoLogEnvioMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.UltimoLogEnvioMde := Value;
end;

function TspdNFeSCAN.Get_UltimoLogRetornoMde: WideString;
begin
    Result := DefaultInterface.UltimoLogRetornoMde;
end;

procedure TspdNFeSCAN.Set_UltimoLogRetornoMde(const Value: WideString);
  { Warning: The property UltimoLogRetornoMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.UltimoLogRetornoMde := Value;
end;

function TspdNFeSCAN.Get_DiagnosticMode: WordBool;
begin
    Result := DefaultInterface.DiagnosticMode;
end;

procedure TspdNFeSCAN.Set_DiagnosticMode(Value: WordBool);
begin
  DefaultInterface.Set_DiagnosticMode(Value);
end;

function TspdNFeSCAN.Get_HttpLibs: WideString;
begin
    Result := DefaultInterface.HttpLibs;
end;

procedure TspdNFeSCAN.Set_HttpLibs(const Value: WideString);
  { Warning: The property HttpLibs has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.HttpLibs := Value;
end;

function TspdNFeSCAN.Get_ModeloDanfeXmlResumo: WideString;
begin
    Result := DefaultInterface.ModeloDanfeXmlResumo;
end;

procedure TspdNFeSCAN.Set_ModeloDanfeXmlResumo(const Value: WideString);
  { Warning: The property ModeloDanfeXmlResumo has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.ModeloDanfeXmlResumo := Value;
end;
...
function TspdNFeSCAN.GetVencimentoCertificadoDataHora: WideString;
begin
  Result := DefaultInterface.GetVencimentoCertificadoDataHora;
end;
...
function TspdNFeSCAN.CalculaChaveInutilizacao(const aAno: WideString; const aCNPJCPF: WideString; 
                                              const aModelo: WideString; const aSerie: WideString; 
                                              const aNFIni: WideString; const aNFFin: WideString): WideString;
begin
  Result := DefaultInterface.CalculaChaveInutilizacao(aAno, aCNPJCPF, aModelo, aSerie, aNFIni, 
                                                      aNFFin);
end;

function TspdNFeSCAN.ObterCodigoUF(const aUF: WideString): Integer;
begin
  Result := DefaultInterface.ObterCodigoUF(aUF);
end;

function TspdNFeSCAN.TratarXMLRetornoDFe(const aXML: WideString; const aDiretorio: WideString): WideString;
begin
  Result := DefaultInterface.TratarXMLRetornoDFe(aXML, aDiretorio);
end;

function TspdNFeSCAN.EnviarAtorInteressado(const aChaveNFe: WideString; const aOrgao: WideString; 
                                           const aDataHoraEvento: WideString; 
                                           const aIdLote: WideString; 
                                           const aOrgaoAutor: WideString; 
                                           const aCnpjCpfAutorizado: WideString; 
                                           const aVersaoAplicativo: WideString; 
                                           aSequenciaEvento: SYSINT; aTpAutor: TipoAtorInteressado; 
                                           aTpAutorizacao: TipoAutorizacaoAtorInteressado; 
                                           const aFusoHorario: WideString): WideString;
begin
  Result := DefaultInterface.EnviarAtorInteressado(aChaveNFe, aOrgao, aDataHoraEvento, aIdLote, 
                                                   aOrgaoAutor, aCnpjCpfAutorizado, 
                                                   aVersaoAplicativo, aSequenciaEvento, aTpAutor, 
                                                   aTpAutorizacao, aFusoHorario);
end;

function TspdNFeSCAN.EnviarComprovanteEntrega(const aChaveNFe: WideString; 
                                              const aOrgao: WideString; 
                                              const aDataHoraEvento: WideString; 
                                              const aIdLote: WideString; 
                                              const aOrgaoAutor: WideString; 
                                              ...
                                              const aNumDocIdent: WideString; 
                                              const aNomeAssinanteComp: WideString; 
                                              const aLatitude: WideString; 
                                              const aLongitude: WideString; 
                                              const aPathImagemEntrega: WideString; 
                                              aSequenciaEvento: SYSINT; 
                                              aTpAutor: TipoAtorComprovanteEntrega): WideString;
begin
  Result := DefaultInterface.EnviarComprovanteEntrega(aChaveNFe, aOrgao, aDataHoraEvento, aIdLote, 
                                                      aOrgaoAutor, aDataHoraEntrega, 
                                                      aVersaoAplicativo, aFusoHorario, 
                                                      aNumDocIdent, aNomeAssinanteComp, aLatitude, 
                                                      aLongitude, aPathImagemEntrega, 
                                                      aSequenciaEvento, aTpAutor);
end;

function TspdNFeSCAN.CancelarComprovanteEntrega(const aIdLote: WideString; 
                                                const aChaveNFe: WideString; 
                                                const aNumProtocoloEvento: WideString; 
                                                const aOrgao: WideString; 
                                                const aOrgaoAutor: WideString; 
                                                ...
                                                aTpAutor: TipoAtorComprovanteEntrega): WideString;
begin
  Result := DefaultInterface.CancelarComprovanteEntrega(aIdLote, aChaveNFe, aNumProtocoloEvento, 
                                                        aOrgao, aOrgaoAutor, aVersaoAplicativo, 
                                                        aDataHoraEvento, aFusoHorario, 
                                                        aSequenciaEvento, aTpAutor);
end;

function TspdNFeSCAN.CalcularCodigoBarrasNFeOffline(const aXmlEnvio: WideString): WideString;
begin
  Result := DefaultInterface.CalcularCodigoBarrasNFeOffline(aXmlEnvio);
end;
...
function TspdNFeSCANProperties.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdNFeSCANProperties.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdNFeSCANProperties.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdNFeSCANProperties.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdNFeSCANProperties.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdNFeSCANProperties.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdNFeSCANProperties.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdNFeSCANProperties.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdNFeSCANProperties.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdNFeSCANProperties.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdNFeSCANProperties.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdNFeSCANProperties.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdNFeSCANProperties.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdNFeSCANProperties.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdNFeSCANProperties.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdNFeSCANProperties.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdNFeSCANProperties.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdNFeSCANProperties.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdNFeSCANProperties.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeSCANProperties.Get_UltimoLogEnvioMde: WideString;
begin
    Result := DefaultInterface.UltimoLogEnvioMde;
end;

procedure TspdNFeSCANProperties.Set_UltimoLogEnvioMde(const Value: WideString);
  { Warning: The property UltimoLogEnvioMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_UltimoLogRetornoMde: WideString;
begin
    Result := DefaultInterface.UltimoLogRetornoMde;
end;

procedure TspdNFeSCANProperties.Set_UltimoLogRetornoMde(const Value: WideString);
  { Warning: The property UltimoLogRetornoMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_DiagnosticMode: WordBool;
begin
    Result := DefaultInterface.DiagnosticMode;
end;

procedure TspdNFeSCANProperties.Set_DiagnosticMode(Value: WordBool);
begin
  DefaultInterface.Set_DiagnosticMode(Value);
end;

function TspdNFeSCANProperties.Get_HttpLibs: WideString;
begin
    Result := DefaultInterface.HttpLibs;
end;

procedure TspdNFeSCANProperties.Set_HttpLibs(const Value: WideString);
  { Warning: The property HttpLibs has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeSCANProperties.Get_ModeloDanfeXmlResumo: WideString;
begin
    Result := DefaultInterface.ModeloDanfeXmlResumo;
end;

procedure TspdNFeSCANProperties.Set_ModeloDanfeXmlResumo(const Value: WideString);
  { Warning: The property ModeloDanfeXmlResumo has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdNFeDPECX.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdNFeDPECX.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdNFeDPECX.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdNFeDPECX.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdNFeDPECX.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdNFeDPECX.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdNFeDPECX.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdNFeDPECX.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdNFeDPECX.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdNFeDPECX.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdNFeDPECX.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdNFeDPECX.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdNFeDPECX.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECX.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdNFeDPECX.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdNFeDPECX.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdNFeDPECX.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdNFeDPECX.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdNFeDPECX.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeDPECX.GetVencimentoCertificadoDataHora: WideString;
begin
  Result := DefaultInterface.GetVencimentoCertificadoDataHora;
end;
...
function TspdNFeDPECXProperties.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdNFeDPECXProperties.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdNFeDPECXProperties.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdNFeDPECXProperties.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdNFeDPECXProperties.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdNFeDPECXProperties.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdNFeDPECXProperties.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdNFeDPECXProperties.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdNFeDPECXProperties.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdNFeDPECXProperties.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdNFeDPECXProperties.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdNFeDPECXProperties.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdNFeDPECXProperties.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdNFeDPECXProperties.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeDPECXProperties.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdNFeDPECXProperties.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdNFeDPECXProperties.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdNFeDPECXProperties.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdNFeDPECXProperties.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdNFeDPECXProperties.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeX.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdNFeX.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdNFeX.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdNFeX.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdNFeX.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdNFeX.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdNFeX.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdNFeX.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdNFeX.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdNFeX.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdNFeX.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdNFeX.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdNFeX.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdNFeX.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdNFeX.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdNFeX.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdNFeX.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdNFeX.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdNFeX.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeX.Get_UltimoLogEnvioMde: WideString;
begin
    Result := DefaultInterface.UltimoLogEnvioMde;
end;

procedure TspdNFeX.Set_UltimoLogEnvioMde(const Value: WideString);
  { Warning: The property UltimoLogEnvioMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_UltimoLogRetornoMde: WideString;
begin
    Result := DefaultInterface.UltimoLogRetornoMde;
end;

procedure TspdNFeX.Set_UltimoLogRetornoMde(const Value: WideString);
  { Warning: The property UltimoLogRetornoMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_DiagnosticMode: WordBool;
begin
    Result := DefaultInterface.DiagnosticMode;
end;

procedure TspdNFeX.Set_DiagnosticMode(Value: WordBool);
begin
  DefaultInterface.Set_DiagnosticMode(Value);
end;

function TspdNFeX.Get_HttpLibs: WideString;
begin
    Result := DefaultInterface.HttpLibs;
end;

procedure TspdNFeX.Set_HttpLibs(const Value: WideString);
  { Warning: The property HttpLibs has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.Get_ModeloDanfeXmlResumo: WideString;
begin
    Result := DefaultInterface.ModeloDanfeXmlResumo;
end;

procedure TspdNFeX.Set_ModeloDanfeXmlResumo(const Value: WideString);
  { Warning: The property ModeloDanfeXmlResumo has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeX.GetVencimentoCertificadoDataHora: WideString;
begin
  Result := DefaultInterface.GetVencimentoCertificadoDataHora;
end;
...
function TspdNFeX.CalculaChaveInutilizacao(const aAno: WideString; const aCNPJCPF: WideString; 
                                           const aModelo: WideString; const aSerie: WideString; 
                                           const aNFIni: WideString; const aNFFin: WideString): WideString;
begin
  Result := DefaultInterface.CalculaChaveInutilizacao(aAno, aCNPJCPF, aModelo, aSerie, aNFIni, 
...
function TspdNFeX.ObterCodigoUF(const aUF: WideString): Integer;
begin
  Result := DefaultInterface.ObterCodigoUF(aUF);
end;

function TspdNFeX.TratarXMLRetornoDFe(const aXML: WideString; const aDiretorio: WideString): WideString;
begin
  Result := DefaultInterface.TratarXMLRetornoDFe(aXML, aDiretorio);
end;

function TspdNFeX.EnviarAtorInteressado(const aChaveNFe: WideString; const aOrgao: WideString; 
                                        const aDataHoraEvento: WideString; 
                                        const aIdLote: WideString; const aOrgaoAutor: WideString; 
                                        const aCnpjCpfAutorizado: WideString; 
                                        const aVersaoAplicativo: WideString; 
                                        aSequenciaEvento: SYSINT; aTpAutor: TipoAtorInteressado; 
                                        aTpAutorizacao: TipoAutorizacaoAtorInteressado; 
...
function TspdNFeX.EnviarComprovanteEntrega(const aChaveNFe: WideString; const aOrgao: WideString; 
                                           const aDataHoraEvento: WideString; 
                                           const aIdLote: WideString; 
                                           const aOrgaoAutor: WideString; 
                                           const aDataHoraEntrega: WideString; 
...
function TspdNFeX.CancelarComprovanteEntrega(const aIdLote: WideString; 
                                             const aChaveNFe: WideString; 
                                             const aNumProtocoloEvento: WideString; 
                                             const aOrgao: WideString; 
                                             const aOrgaoAutor: WideString; 
...
function TspdNFeX.CalcularCodigoBarrasNFeOffline(const aXmlEnvio: WideString): WideString;
begin
  Result := DefaultInterface.CalcularCodigoBarrasNFeOffline(aXmlEnvio);
end;
...
function TspdNFeXProperties.Get_IdCSRT: WideString;
begin
    Result := DefaultInterface.IdCSRT;
end;

procedure TspdNFeXProperties.Set_IdCSRT(const Value: WideString);
  { Warning: The property IdCSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_CSRT: WideString;
begin
    Result := DefaultInterface.CSRT;
end;

procedure TspdNFeXProperties.Set_CSRT(const Value: WideString);
  { Warning: The property CSRT has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_ImprimirLocalRetiradaEntrega: WordBool;
begin
    Result := DefaultInterface.ImprimirLocalRetiradaEntrega;
end;

procedure TspdNFeXProperties.Set_ImprimirLocalRetiradaEntrega(Value: WordBool);
begin
  DefaultInterface.Set_ImprimirLocalRetiradaEntrega(Value);
end;

function TspdNFeXProperties.Get_InfCplQuebrarLinhaAut: WordBool;
begin
    Result := DefaultInterface.InfCplQuebrarLinhaAut;
end;

procedure TspdNFeXProperties.Set_InfCplQuebrarLinhaAut(Value: WordBool);
begin
  DefaultInterface.Set_InfCplQuebrarLinhaAut(Value);
end;

function TspdNFeXProperties.Get_ConfigTextoRodapeEsq: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeEsq;
end;

procedure TspdNFeXProperties.Set_ConfigTextoRodapeEsq(const Value: WideString);
  { Warning: The property ConfigTextoRodapeEsq has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_ConfigTextoRodapeDir: WideString;
begin
    Result := DefaultInterface.ConfigTextoRodapeDir;
end;

procedure TspdNFeXProperties.Set_ConfigTextoRodapeDir(const Value: WideString);
  { Warning: The property ConfigTextoRodapeDir has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_MensagemIcmsDesonerado: WordBool;
begin
    Result := DefaultInterface.MensagemIcmsDesonerado;
end;

procedure TspdNFeXProperties.Set_MensagemIcmsDesonerado(Value: WordBool);
begin
  DefaultInterface.Set_MensagemIcmsDesonerado(Value);
end;

function TspdNFeXProperties.Get_EmailEmitente: WideString;
begin
    Result := DefaultInterface.EmailEmitente;
end;

procedure TspdNFeXProperties.Set_EmailEmitente(const Value: WideString);
  { Warning: The property EmailEmitente has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_CnpjSoftwareHouse: WideString;
begin
    Result := DefaultInterface.CnpjSoftwareHouse;
end;

procedure TspdNFeXProperties.Set_CnpjSoftwareHouse(const Value: WideString);
  { Warning: The property CnpjSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_TokenSoftwareHouse: WideString;
begin
    Result := DefaultInterface.TokenSoftwareHouse;
end;

procedure TspdNFeXProperties.Set_TokenSoftwareHouse(const Value: WideString);
  { Warning: The property TokenSoftwareHouse has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_EmailUseSecureBlackBox: WordBool;
begin
    Result := DefaultInterface.EmailUseSecureBlackBox;
end;

procedure TspdNFeXProperties.Set_EmailUseSecureBlackBox(Value: WordBool);
begin
  DefaultInterface.Set_EmailUseSecureBlackBox(Value);
end;

function TspdNFeXProperties.Get_EmailQtdeTentativas: Integer;
begin
    Result := DefaultInterface.EmailQtdeTentativas;
end;

procedure TspdNFeXProperties.Set_EmailQtdeTentativas(Value: Integer);
begin
  DefaultInterface.Set_EmailQtdeTentativas(Value);
end;

function TspdNFeXProperties.Get_EmailUseTLS: UseTLS;
begin
    Result := DefaultInterface.EmailUseTLS;
end;

procedure TspdNFeXProperties.Set_EmailUseTLS(Value: UseTLS);
begin
  DefaultInterface.Set_EmailUseTLS(Value);
end;
...
function TspdNFeXProperties.Get_UltimoLogEnvioMde: WideString;
begin
    Result := DefaultInterface.UltimoLogEnvioMde;
end;

procedure TspdNFeXProperties.Set_UltimoLogEnvioMde(const Value: WideString);
  { Warning: The property UltimoLogEnvioMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_UltimoLogRetornoMde: WideString;
begin
    Result := DefaultInterface.UltimoLogRetornoMde;
end;

procedure TspdNFeXProperties.Set_UltimoLogRetornoMde(const Value: WideString);
  { Warning: The property UltimoLogRetornoMde has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_DiagnosticMode: WordBool;
begin
    Result := DefaultInterface.DiagnosticMode;
end;

procedure TspdNFeXProperties.Set_DiagnosticMode(Value: WordBool);
begin
  DefaultInterface.Set_DiagnosticMode(Value);
end;

function TspdNFeXProperties.Get_HttpLibs: WideString;
begin
    Result := DefaultInterface.HttpLibs;
end;

procedure TspdNFeXProperties.Set_HttpLibs(const Value: WideString);
  { Warning: The property HttpLibs has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TspdNFeXProperties.Get_ModeloDanfeXmlResumo: WideString;
begin
    Result := DefaultInterface.ModeloDanfeXmlResumo;
end;

procedure TspdNFeXProperties.Set_ModeloDanfeXmlResumo(const Value: WideString);
  { Warning: The property ModeloDanfeXmlResumo has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
