...
begin
  ...
  begin
    ...
    Form7.ibDataSet7.Edit;
    Form7.ibDataSet7NN.AsString := StrZero(StrToInt64(Form7.ibDataSet99.FieldByname('GEN_ID').AsString), 10, 0); // Sandro Silva 2024-04-02 Form7.ibDataSet7NN.AsString := strZero(StrToInt(Form7.ibDataSet99.FieldByname('GEN_ID').AsString),10,0);
  ...
  begin
    Form26.medtNossoNu.Text := Right('00000000000'+LimpaNumero( Form7.ibDataSet7NN.AsString),10) +'-'+Modulo_11(LimpaNumero( Form7.ibDataSet7NN.AsString));
  end;
