...
begin
  ...
  if _ecf02 = nil then
  begin
    _ecf02 := TBemaFI.Create(nil); // Sandro Silva 2020-09-22
  end;
...
begin
  ...
  if Form1.fTEFPago                      > 0 then Result := (Bematech_FI_AbreComprovanteNaoFiscalVinculado( pchar('Cartao'), pChar(StrZero(Form1.fTEFPago*100,12,0)), pChar(CupomFormatado(Form1.icupom)) )=1);
