...
unit uconfiguracaogerenciadorestef;
...
type
  TFConfiguracaoGerenciadoresTEF = class(TForm)
    Button1: TBitBtn;
    Panel2: TPanel;
...
var
  FConfiguracaoGerenciadoresTEF: TFConfiguracaoGerenciadoresTEF;
...
procedure TFConfiguracaoGerenciadoresTEF.Button1Click(Sender: TObject);
begin
  if SalvarAdquirente then
    Close;
end;

procedure TFConfiguracaoGerenciadoresTEF.Image6Click(Sender: TObject);
begin
  Button1Click(Sender);
end;

procedure TFConfiguracaoGerenciadoresTEF.FormActivate(Sender: TObject);
begin
  //
  //
...
procedure TFConfiguracaoGerenciadoresTEF.FormCreate(Sender: TObject);
var
  iColuna: Integer;
  iLargura: Integer;
begin
  ...
  AjustaResolucao(FConfiguracaoGerenciadoresTEF);
...
procedure TFConfiguracaoGerenciadoresTEF.FormShow(Sender: TObject);
begin
  CarregarAdquirentes;
...
procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESAfterInsert(DataSet: TDataSet);
begin
...
procedure TFConfiguracaoGerenciadoresTEF.CarregarAdquirentes;
var
  iSecao: Integer;
  sNomeSecao: String;
begin
...
procedure TFConfiguracaoGerenciadoresTEF.FormClose(Sender: TObject;
...
function TFConfiguracaoGerenciadoresTEF.SalvarAdquirente: Boolean;
var
  iSecao: Integer;
  sNomeSecao: String;
  iQtdPadrao: Integer;
...
procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESExit(Sender: TObject);
begin
  if (Sender as TDBGrid).DataSource.DataSet.State in [dsEdit, dsInsert] then
    (Sender as TDBGrid).DataSource.DataSet.Post;
end;

procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESBeforePost(DataSet: TDataSet);
begin
  DataSet.FieldByName('ADQUIRENTE').AsString := AnsiUpperCase(DataSet.FieldByName('ADQUIRENTE').AsString);
end;

procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESPostError(DataSet: TDataSet;
...
procedure TFConfiguracaoGerenciadoresTEF.Button2Click(Sender: TObject);
begin
  Close;
  //ModalResult := mrCancel;
end;

procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESPADRAOSetText(Sender: TField;
  const Text: String);
begin
...
procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESATIVOSetText(Sender: TField;
  const Text: String);
begin
  if AnsiUpperCase(Text) = 'SIM' then
    Sender.AsString := 'Sim'
...
procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESADQUIRENTESetText(Sender: TField;
  const Text: String);
begin
...
procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESKeyUp(Sender: TObject;
...
procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESColEnter(Sender: TObject);
begin
...
procedure TFConfiguracaoGerenciadoresTEF.DeletarRecord(Sender: TObject);
begin
...
procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  R: TRect;
...
procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESCellClick(Column: TColumn);
begin
  if Column.FieldName = 'EXCLUIR' then
    DeletarRecord(GRIDADQUIRENTES);
end;

procedure TFConfiguracaoGerenciadoresTEF.GRIDADQUIRENTESEnter(Sender: TObject);
begin
  ExibeOrientacao(Sender);
end;

procedure TFConfiguracaoGerenciadoresTEF.ExibeOrientacao(Sender: TObject);
begin
...
function TFConfiguracaoGerenciadoresTEF.GeraChaveRequisicaoIntegradorFiscal(
  sAdquirente: String; sNumeroPOS: String): String;
var
  sChaveRequisicao: String;
begin
...
procedure TFConfiguracaoGerenciadoresTEF.CDSADQUIRENTESSERIALPOSSetText(Sender: TField;
  const Text: String);
begin
  Sender.Value := AnsiUpperCase(Text);
