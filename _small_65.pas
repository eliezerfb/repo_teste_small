      ...
      begin
        ...
        begin
          ...
          begin
            ...
            SmallMsg('Small - NFC-e ' + ' - ' + FormatDateTime('dd/mm/yyyy HH:nn:ss', Now) + ' ' + Form22.sBuild + Chr(10) + Chr(10) + sLogErro); // Sandro Silva 2020-09-03 SmallMsg(PChar('Small - NFC-e ' + ' - ' + FormatDateTime('dd/mm/yyyy HH:nn:ss', Now) + ' ' + Form22.sBuild + Chr(10) + Chr(10) + sLogErro));
        end;
      end
      else
      begin
