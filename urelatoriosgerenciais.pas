    ...
    try
      ...
      begin
        ...
        IBQNFCE.SQL.Text :=
          ...
          'from NFCE ' +
          'join ALTERACA A on A.PEDIDO = NFCE.NUMERONF and A.CAIXA = NFCE.CAIXA ' +
          'where (NFCE.STATUS containing ''Autorizad'' or NFCE.STATUS containing ''Emitido com sucesso'' or NFCE.STATUS containing ' + QuotedStr(NFCE_EMITIDA_EM_CONTINGENCIA) + ' or NFCE.STATUS containing ' + QuotedStr(VENDA_GERENCIAL_FINALIZADA) + ') ';
...
begin
  ...
  try
    ...
    IBQNFCE.SQL.Text :=
      ...
      ' and (N.STATUS containing ''Autoriza'' or N.STATUS containing ''Emitido com sucesso'' or N.STATUS containing ' + QuotedStr(NFCE_EMITIDA_EM_CONTINGENCIA) + ' or N.STATUS containing ' + QuotedStr(VENDA_GERENCIAL_FINALIZADA) + ' ) ' + // Ficha 4819 Sandro Silva 2020-02-18 ' and (N.STATUS containing ''Autoriza'' or N.STATUS containing ''Emitido com sucesso'' ) ' +
