  ...
  try
    ...
    begin
      ...
      Form1.ibDataSet99.SelectSql.Text :=
        ...
        ' and coalesce(P.CLIFOR, ''X'') <> ''Sangria'' ' +
        ' and coalesce(P.CLIFOR, ''X'') <> ''Suprimento'' ' +
        ' and P.CAIXA = ' + QuotedStr(IBQuery5.FieldByName('CAIXA').AsString) + // dos cupons fiscais só do caixa
        ' order by P.FORMA';
      ...
      begin
        ...
        Form1.ibDataSet27.SelectSQL.Text :=
          ...
          ' and CAIXA = ' + QuotedStr(IBQuery5.FieldByName('CAIXA').AsString) + // dos cupons fiscais só do caixa
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            sS2Conta := Copy(RightStr(IBQuery5.FieldByName('PEDIDO').AsString, 3) + sEvidenciaS2 + Replicate(' ', 10), 1, 13);  // Número da mesa/Conta cliente
